...
print(f"Polynomial Regression Mean Squares Error: {mse_poly}")
...
for i in range(10):
  rounded_prediction = round(y_pred_poly[i]) 
#print(f"Actual shift: {y_test[i]}, Predicted shift: {y_pred[i]:.2f}, Rounded Prediction: {rounded_prediction}")
  print(f"Actual Shift: {y_test[i]}, Predicted Shift: {rounded_prediction}")
# %% 
